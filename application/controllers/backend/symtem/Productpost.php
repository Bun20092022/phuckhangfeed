...
class Productpost extends MY_Controller {
	public function __construct()
	{
		parent::__construct();
		$this->main = 'backend/layout/v_main';
		$this->folder = 'backend/symtem/productpost';
		$this->id_symtem_template = 12;
	}
	public function index()
	{
		...
		$data['title'] = 'Hiển thị chuyên mục bài viết sản phẩm';
