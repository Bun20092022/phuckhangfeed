...
class Khauhieu extends MY_Controller {
	public function __construct()
	{
		parent::__construct();
		$this->main = 'backend/layout/v_main';
		$this->folder = 'backend/symtem/khauhieu';
		$this->id_symtem_template = 21;
	}
