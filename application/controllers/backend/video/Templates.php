...
class Templates extends My_Controller {
	...
	public function __construct()
	{
		...
		$this->folder = 'backend/video/templates';
		$this->post_type_id = 3;
	...
	public function add($template_type)
	{
		if (isset($_POST['add'])) {
			...
			$url_save = 'frontent/video/video_'.$result.'.php';
			$url_file = 'application/views/frontent/video/video_'.$result.'.php';
