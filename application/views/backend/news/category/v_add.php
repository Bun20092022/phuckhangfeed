            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="mb-3">
                     ...
                     <textarea class="form-control" rows="5" name="description_<?= $this->id_language;?>"></textarea>
                  </div>
                  <div class="mb-3">
                  ...
                  <div class="mb-3">
                     ...
                     <div class="row">
                        <div class="col-md-8">
                           <input id="xFilePath2" name="imgbackground_<?= $this->id_language;?>" type="text" size="60" class="form-control">
                        </div>
                        <div class="col-md-4">
